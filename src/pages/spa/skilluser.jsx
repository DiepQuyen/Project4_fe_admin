...
const SkillManagement = () => {
  ...
  useEffect(() => {
    setLoading(true);
    Promise.all([
      axios.get('https://sparlex-spa.up.railway.app/api/v1/user/accounts/staff'),
      axios.get('https://sparlex-spa.up.railway.app/api/v1/skills'),
      axios.get('https://sparlex-spa.up.railway.app/api/v1/user-skills'),
    ])
  ...
  const handleSaveAssignment = () => {
    ...
    const requests = userIds.map((id) => {
      ...
      if (dialogType === 'add') {
        axios.post('https://sparlex-spa.up.railway.app/api/v1/user-skills/insert', payload);
        loadData();
      } else {
        axios.put(`https://sparlex-spa.up.railway.app/api/v1/user-skills/edit`, payload);
        loadData();
      }
    });

    Promise.all(requests)
      .then(() => axios.get('https://sparlex-spa.up.railway.app/api/v1/user-skills'))
      .then((res) => {
  ...
  const handleDeleteAssignment = (employeeId) => {
    ...
    axios
      .delete(`https://sparlex-spa.up.railway.app/api/v1/user-skills/delete/${employeeId}`)
      .then(() => axios.get('https://sparlex-spa.up.railway.app/api/v1/user-skills'))
      .then((res) => {
        setUserSkills(res.data);
  ...
  const handleSaveNewSkill = () => {
    ...
    axios.post('https://sparlex-spa.up.railway.app/api/v1/skills', { skillName: newSkillName })
      .then(() => {
        toast.success('Thêm kỹ năng mới thành công!');
        handleCloseNewSkillDialog();
        return axios.get('https://sparlex-spa.up.railway.app/api/v1/skills');
      })
  ...
  const handleUpdateSkill = () => {
    ...
    axios.put(`https://sparlex-spa.up.railway.app/api/v1/skills/${editingSkill.id}`, { skillName: editingSkill.skillName })
        .then(() => {
  ...
  const handleDeleteSkill = (skillId) => {
    Swal.fire({
      ...
      axios.delete(`https://sparlex-spa.up.railway.app/api/v1/skills/${skillId}`)
        .then(() => {
