...
const SkillManagement = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      axios.get('https://sparlex.up.railway.app/api/v1/skills'),
      axios.get('https://sparlex.up.railway.app/api/v1/user-skills'),
    ])
  ...
  const handleSave = () => {
    ...
    const requests = userIds.map((id) => {
      ...
      if (dialogType === 'add') {
        return axios.post('https://sparlex.up.railway.app/api/v1/user-skills/insert', payload);
      } else {
        return axios.put(`https://sparlex.up.railway.app/api/v1/user-skills/edit`, payload);
      }
    });

    Promise.all(requests)
      .then(() => axios.get('https://sparlex.up.railway.app/api/v1/user-skills'))
      .then((res) => {
  ...
  const handleDelete = (employeeId) => {
    ...
    axios
      .delete(`https://sparlex.up.railway.app/api/v1/user-skills/delete/${employeeId}`)
      .then(() => axios.get('https://sparlex.up.railway.app/api/v1/user-skills'))
      .then((res) => {
        setUserSkills(res.data);
