...
const USER_DETAIL_URL = 'https://sparlex-spa.up.railway.app/api/v1/userDetail';
  ...
  const handleImageChange = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const uploadResponse = await fetch('https://sparlex-spa.up.railway.app/api/v1/upload', {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${Cookies.get('admin_token') || Cookies.get('staff_token')}`
          },
